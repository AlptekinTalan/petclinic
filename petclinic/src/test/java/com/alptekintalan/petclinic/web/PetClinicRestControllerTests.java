package com.alptekintalan.petclinic.web;
...
public class PetClinicRestControllerTests {
	...
	public void testGetOwnerById() {
		...
		MatcherAssert.assertThat(response.getBody().getFirstName(), Matchers.equalTo("Ali"));
	}
	...
	public void testGetOwners() {
		...
		MatcherAssert.assertThat(firstNames, Matchers.containsInAnyOrder("Kenan", "Hümeyra", "Salim", "Muhammed"));
	}
